    ...
    return(
        ...
        <form>   
            ...
            <div className="relative bg-violet-100 ">
                ...
                <button type="submit" className="text-white absolute right-2.5 bottom-6 bg-purple-900 hover:bg-purple-900  focus:ring-4 focus:outline-none focus:ring-bg-purple-900 font-medium rounded-lg text-sm px-8 py-2 dark:bg-bg-purple-900  dark:hover:bg-bg-purple-900  dark:focus:ring-white">Filtrar</button>
                <br></br>
            </div>
        </form>
