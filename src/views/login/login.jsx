                                    ...
                                    <div className='flex justify-between items-center'>
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-3 text-sm">
                                              <label for="terms" class="font-light">Recordar contraseña </label>
                                            </div>
                                            <div className='text-right'>
                                                <a class="font-medium text-purple-900 hover:underline dark:text-purple-900 ml-32" href="#">Olvidaste tu contraseña?</a>
                                            </div>
                                        </div>
